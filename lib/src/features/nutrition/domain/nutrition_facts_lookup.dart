...
class NutritionFactsLookup {
  ...
  static const List<NutritionFactsEntry> _catalog = [
    ...
    NutritionFactsEntry(
      name: 'Pera',
      aliases: ['pera', 'peras'],
      servingDescription: '1 mediana (178g)',
      calories: 101,
      protein: 0.6,
      carbs: 27.0,
      fat: 0.2,
    ...
    NutritionFactsEntry(
      name: 'Naranja',
      aliases: ['naranja', 'naranjas', 'orange'],
      servingDescription: '1 mediana (131g)',
      calories: 62,
      protein: 1.2,
      carbs: 15.4,
      fat: 0.2,
    ...
    NutritionFactsEntry(
      ...
      servingDescription: '1 taza en cubos (145g)',
      calories: 62,
      protein: 0.7,
      carbs: 15.7,
      fat: 0.4,
    ...
    NutritionFactsEntry(
      ...
      aliases: ['sopa lentejas', 'sopa de lentejas'],
      servingDescription: '1 taza (240ml)',
      calories: 139,
      protein: 9.0,
      carbs: 24.0,
    ...
    NutritionFactsEntry(
      name: 'Té verde',
      aliases: ['te verde', 'té verde', 'green tea', 'te'],
      servingDescription: '1 taza (240ml)',
      calories: 2,
      protein: 0.0,
      carbs: 0.4,
    ...
    NutritionFactsEntry(
      name: 'Té negro',
      aliases: ['te negro', 'té negro', 'black tea'],
      servingDescription: '1 taza (240ml)',
      calories: 2,
      protein: 0.0,
      carbs: 0.4,
    ...
    NutritionFactsEntry(
      name: 'Té de jengibre',
      aliases: ['te jengibre', 'té de jengibre', 'jengibre', 'ginger tea'],
      servingDescription: '1 taza (240ml)',
      calories: 4,
      protein: 0.1,
      carbs: 0.9,
    ...
    NutritionFactsEntry(
      name: 'Té de canela',
      aliases: ['te canela', 'té de canela', 'canela', 'cinnamon tea'],
      servingDescription: '1 taza (240ml)',
      calories: 3,
      protein: 0.0,
      carbs: 0.8,
