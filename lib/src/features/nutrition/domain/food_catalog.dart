...
class FoodCatalog {
  ...
  static const List<Food> proteins = [
    ...
    Food(
      id: 'pollo', name: 'Pollo',
      category: FoodCategory.protein, qualityScore: 95,
      portionLabel: '100g (palma de la mano)', servingUnit: ServingUnit.portion100g,
    ),
    Food(
      id: 'pechuga_pavo', name: 'Pechuga de pavo',
      category: FoodCategory.protein, qualityScore: 95,
      portionLabel: '100g (palma de la mano)', servingUnit: ServingUnit.portion100g,
    ),
    Food(
      id: 'muslo_pollo', name: 'Muslo de pollo',
      category: FoodCategory.protein, qualityScore: 90,
      portionLabel: '1 muslo (~120g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'huevo', name: 'Huevo',
      category: FoodCategory.protein, qualityScore: 95,
      portionLabel: '1 huevo mediano (~50g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'clara_huevo', name: 'Clara de huevo',
      category: FoodCategory.protein, qualityScore: 98,
      portionLabel: '3 claras (~90g)', servingUnit: ServingUnit.unit,
      searchAliases: ['claras', 'albumina', 'clara'],
    ),

    // Carnes rojas — alta calidad
    Food(
      id: 'carne_res', name: 'Carne de res',
      category: FoodCategory.protein, qualityScore: 90,
      portionLabel: '100g (palma de la mano)', servingUnit: ServingUnit.portion100g,
    ),
    Food(
      id: 'cerdo', name: 'Cerdo',
      category: FoodCategory.protein, qualityScore: 88,
      portionLabel: '100g (palma de la mano)', servingUnit: ServingUnit.portion100g,
    ),
    ...
    Food(
      id: 'atun', name: 'Atún',
      category: FoodCategory.protein, qualityScore: 95,
      portionLabel: '½ lata (~80g)', servingUnit: ServingUnit.portion100g,
    ),
    Food(
      id: 'sardinas', name: 'Sardinas',
      category: FoodCategory.protein, qualityScore: 95,
      portionLabel: '½ lata (~85g)', servingUnit: ServingUnit.portion100g,
    ),
    Food(
    ...
    Food(
      ...
      category: FoodCategory.protein, qualityScore: 90,
      portionLabel: '100g (~12 unidades)', servingUnit: ServingUnit.portion100g,
      searchAliases: ['camarones', 'camaron', 'langostinos'],
    ),
    Food(
      id: 'camaron', name: 'Camarón',
      category: FoodCategory.protein, qualityScore: 92,
      portionLabel: '100g (~10 camarones)', servingUnit: ServingUnit.portion100g,
      searchAliases: ['camarones', 'shrimp', 'gambas'],
    ),
    Food(
      id: 'langostino', name: 'Langostino',
      category: FoodCategory.protein, qualityScore: 92,
      portionLabel: '100g (~6 langostinos)', servingUnit: ServingUnit.portion100g,
    ...
    Food(
      id: 'jamon', name: 'Jamón',
      category: FoodCategory.protein, qualityScore: 80,
      nova: NovaGroup.processed,
      portionLabel: '2 rebanadas (~40g)', servingUnit: ServingUnit.slice,
    ),

    // Lácteos proteicos
    Food(
      id: 'queso_campesino', name: 'Queso campesino',
      category: FoodCategory.protein, qualityScore: 85,
      nova: NovaGroup.processed,
      portionLabel: '1 trozo (~50g)', servingUnit: ServingUnit.portion100g,
    ),
    Food(
      id: 'queso_mozzarella', name: 'Queso mozzarella',
      category: FoodCategory.protein, qualityScore: 80,
      nova: NovaGroup.processed,
      portionLabel: '30g (~2 rebanadas)', servingUnit: ServingUnit.slice,
      searchAliases: ['mozzarella', 'mozarela'],
    ),
    Food(
      id: 'yogur_griego', name: 'Yogur griego',
      category: FoodCategory.protein, qualityScore: 80,
      nova: NovaGroup.processed,
      portionLabel: '1 taza (~200g)', servingUnit: ServingUnit.cup,
    ...
    Food(
      ...
      category: FoodCategory.protein, qualityScore: 80,
      nova: NovaGroup.processed,
      portionLabel: '1 taza (~240ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['kefir', 'yogur kéfir', 'yogur kefir'],
    ),
    Food(
      id: 'ricotta', name: 'Ricotta',
      category: FoodCategory.protein, qualityScore: 75,
      nova: NovaGroup.processed,
      portionLabel: '¼ taza (~60g)', servingUnit: ServingUnit.cup,
      searchAliases: ['requesón', 'requeson'],
    ),
    Food(
      id: 'suero_costeno', name: 'Suero costeño',
      category: FoodCategory.protein, qualityScore: 75,
      nova: NovaGroup.processed,
      portionLabel: '2 cucharadas (~30g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'leche', name: 'Leche',
      category: FoodCategory.protein, qualityScore: 40,
      portionLabel: '1 taza (~250ml)', servingUnit: ServingUnit.cup,
    ),

    // Legumbres — proteína + carbo lento, score 70
    Food(
      id: 'lentejas', name: 'Lentejas',
      category: FoodCategory.protein, qualityScore: 70,
      portionLabel: '½ taza cocida', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'frijoles', name: 'Fríjoles',
      category: FoodCategory.protein, qualityScore: 70,
      portionLabel: '½ taza cocida', servingUnit: ServingUnit.cup,
      searchAliases: ['frijoles'],
    ),
    Food(
      id: 'garbanzos', name: 'Garbanzos',
      category: FoodCategory.protein, qualityScore: 70,
      portionLabel: '½ taza cocida', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'habichuelas', name: 'Habichuelas',
      category: FoodCategory.protein, qualityScore: 80,
      portionLabel: '1 taza cocida', servingUnit: ServingUnit.cup,
    ),
    ...
    Food(
      id: 'tofu', name: 'Tofu',
      category: FoodCategory.protein, qualityScore: 85,
      portionLabel: '100g (~¼ bloque)', servingUnit: ServingUnit.portion100g,
    ),
    Food(
      id: 'tempeh', name: 'Tempeh',
      category: FoodCategory.protein, qualityScore: 85,
      nova: NovaGroup.processed,
      portionLabel: '100g', servingUnit: ServingUnit.portion100g,
      searchAliases: ['tempe'],
    ),
    ...
    Food(
      ...
      category: FoodCategory.protein, qualityScore: 65,
      portionLabel: '½ taza cocida', servingUnit: ServingUnit.cup,
    ...
    Food(
      id: 'caldo_pollo', name: 'Caldo de pollo',
      category: FoodCategory.protein, qualityScore: 75,
      portionLabel: '1 taza (~240ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['consome', 'consome de pollo', 'sopa de pollo'],
    ),
    Food(
      id: 'caldo_costilla', name: 'Caldo de costilla',
      category: FoodCategory.protein, qualityScore: 75,
      portionLabel: '1 taza (~240ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['caldo de res', 'caldo de hueso', 'sancocho'],
    ),
    Food(
      id: 'caldo_pescado', name: 'Caldo de pescado',
      category: FoodCategory.protein, qualityScore: 75,
      portionLabel: '1 taza (~240ml)', servingUnit: ServingUnit.cup,
  ...
  static const List<Food> fats = [
    ...
    Food(
      ...
      category: FoodCategory.fat, qualityScore: 100,
      portionLabel: '½ aguacate mediano (~100g)', servingUnit: ServingUnit.portion100g,
      searchAliases: ['palta'],
    ),
    Food(
      id: 'aceite_oliva', name: 'Aceite de oliva',
      category: FoodCategory.fat, qualityScore: 100,
      portionLabel: '1 cucharada (~15ml)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'aceite_coco', name: 'Aceite de coco',
      category: FoodCategory.fat, qualityScore: 95,
      portionLabel: '1 cucharada (~14g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'aceite_aguacate', name: 'Aceite de aguacate',
      category: FoodCategory.fat, qualityScore: 100,
      nova: NovaGroup.processed,
      portionLabel: '1 cucharada (~15ml)', servingUnit: ServingUnit.tablespoon,
    ...
    Food(
      id: 'aceite_vegetal', name: 'Aceite vegetal',
      category: FoodCategory.fat, qualityScore: 60,
      nova: NovaGroup.processed,
      portionLabel: '1 cucharada (~15ml)', servingUnit: ServingUnit.tablespoon,
    ),
    ...
    Food(
      ...
      category: FoodCategory.fat, qualityScore: 95,
      portionLabel: '1 puñado (~28g)', servingUnit: ServingUnit.handful,
    ),
    Food(
      id: 'nueces', name: 'Nueces',
      category: FoodCategory.fat, qualityScore: 95,
      portionLabel: '1 puñado (~30g, ~7 nueces)', servingUnit: ServingUnit.handful,
    ),
    Food(
      id: 'macadamia', name: 'Macadamia',
      category: FoodCategory.fat, qualityScore: 95,
      portionLabel: '1 puñado (~28g, ~11 nueces)', servingUnit: ServingUnit.handful,
      searchAliases: ['nueces macadamia', 'nuez de macadamia'],
    ),
    Food(
      id: 'avellanas', name: 'Avellanas',
      category: FoodCategory.fat, qualityScore: 90,
      portionLabel: '1 puñado (~28g)', servingUnit: ServingUnit.handful,
      searchAliases: ['hazelnuts'],
    ),
    Food(
      id: 'mani', name: 'Maní',
      category: FoodCategory.fat, qualityScore: 80,
      portionLabel: '1 puñado (~28g)', servingUnit: ServingUnit.handful,
    ...
    Food(
      id: 'semillas_girasol', name: 'Semillas de girasol',
      category: FoodCategory.fat, qualityScore: 90,
      portionLabel: '2 cucharadas (~20g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'semillas_calabaza', name: 'Semillas de calabaza',
      category: FoodCategory.fat, qualityScore: 90,
      portionLabel: '2 cucharadas (~20g)', servingUnit: ServingUnit.tablespoon,
    ...
    Food(
      id: 'coco', name: 'Coco',
      category: FoodCategory.fat, qualityScore: 85,
      portionLabel: '¼ taza rallado (~25g)', servingUnit: ServingUnit.cup,
    ),

    // Pastas y cremas de frutos secos
    Food(
      id: 'mantequilla_almendras', name: 'Mantequilla de almendras',
      category: FoodCategory.fat, qualityScore: 85,
      nova: NovaGroup.processed,
      portionLabel: '2 cucharadas (~32g)', servingUnit: ServingUnit.tablespoon,
    ...
    Food(
      ...
      nova: NovaGroup.processed,
      portionLabel: '2 cucharadas (~30g)', servingUnit: ServingUnit.tablespoon,
      searchAliases: ['pasta de ajonjoli', 'pasta de sesamo', 'pasta de sésamo'],
    ),
    Food(
      id: 'ajonjoli', name: 'Ajonjolí',
      category: FoodCategory.fat, qualityScore: 90,
      portionLabel: '1 cucharada (~9g)', servingUnit: ServingUnit.tablespoon,
    ...
    Food(
      ...
      category: FoodCategory.fat, qualityScore: 95,
      portionLabel: '10 aceitunas (~35g)', servingUnit: ServingUnit.handful,
    ),
    ...
    Food(
      id: 'leche_coco', name: 'Leche de coco',
      category: FoodCategory.fat, qualityScore: 85,
      nova: NovaGroup.processed,
      portionLabel: '½ taza (~120ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['coconut milk', 'crema de coco'],
    ),
    Food(
      id: 'queso_amarillo', name: 'Queso amarillo',
      category: FoodCategory.fat, qualityScore: 75,
      nova: NovaGroup.processed,
      portionLabel: '1 rebanada (~20g)', servingUnit: ServingUnit.slice,
    ),
    Food(
      id: 'queso_crema', name: 'Queso crema',
      category: FoodCategory.fat, qualityScore: 75,
      nova: NovaGroup.processed,
      portionLabel: '2 cucharadas (~30g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'crema_de_leche', name: 'Crema de leche',
      category: FoodCategory.fat, qualityScore: 70,
      nova: NovaGroup.processed,
      portionLabel: '2 cucharadas (~30ml)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'leche_entera', name: 'Leche entera',
      category: FoodCategory.fat, qualityScore: 50,
      portionLabel: '1 taza (~250ml)', servingUnit: ServingUnit.cup,
    ),
    ...
    Food(
      ...
      category: FoodCategory.fat, qualityScore: 75,
      nova: NovaGroup.processed,
      portionLabel: '2 tiras (~30g)', servingUnit: ServingUnit.slice,
    ),
    Food(
      id: 'chicharron', name: 'Chicharrón',
      category: FoodCategory.fat, qualityScore: 70,
      nova: NovaGroup.processed,
      portionLabel: '100g', servingUnit: ServingUnit.portion100g,
    ),
    Food(
      ...
      category: FoodCategory.fat, qualityScore: 60,
      nova: NovaGroup.processed,
      portionLabel: '1 chorizo (~80g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'salchicha', name: 'Salchicha',
      category: FoodCategory.fat, qualityScore: 50,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 salchicha (~50g)', servingUnit: ServingUnit.unit,
    ),
    ...
    Food(
      ...
      category: FoodCategory.fat, qualityScore: 50,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 cucharada (~15g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'manteca', name: 'Manteca',
      category: FoodCategory.fat, qualityScore: 55,
      nova: NovaGroup.culinaryIngredient,
      portionLabel: '1 cucharada (~15g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'margarina', name: 'Margarina',
      category: FoodCategory.fat, qualityScore: 30,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 cucharada (~14g)', servingUnit: ServingUnit.tablespoon,
    ),
    ...
    Food(
      id: 'semillas_chia', name: 'Semillas de chía',
      category: FoodCategory.fat, qualityScore: 95,
      portionLabel: '1 cucharada (~12g)', servingUnit: ServingUnit.tablespoon,
      searchAliases: ['chia'],
    ),
    Food(
      id: 'linaza', name: 'Linaza',
      category: FoodCategory.fat, qualityScore: 95,
      portionLabel: '1 cucharada (~10g)', servingUnit: ServingUnit.tablespoon,
  ...
  static const List<Food> carbs = [
    ...
    Food(
      id: 'brocoli', name: 'Brócoli',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '1 taza (~91g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'espinaca', name: 'Espinaca',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '1 taza cruda (~30g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'lechuga', name: 'Lechuga',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '2 tazas (~85g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'tomate', name: 'Tomate',
      category: FoodCategory.carb, qualityScore: 95,
      portionLabel: '1 tomate mediano (~123g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'pepino', name: 'Pepino',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '½ pepino (~150g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'calabacin', name: 'Calabacín',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '1 taza en cubos (~113g)', servingUnit: ServingUnit.cup,
      searchAliases: ['zucchini', 'zapallito'],
    ),
    Food(
      id: 'coliflor', name: 'Coliflor',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '1 taza en floretes (~100g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'pimiento', name: 'Pimiento',
      category: FoodCategory.carb, qualityScore: 95,
      portionLabel: '1 pimiento mediano (~119g)', servingUnit: ServingUnit.unit,
      searchAliases: ['morron', 'aji dulce'],
    ),
    Food(
      id: 'zanahoria', name: 'Zanahoria',
      category: FoodCategory.carb, qualityScore: 75,
      portionLabel: '1 zanahoria mediana (~61g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'cebolla', name: 'Cebolla',
      category: FoodCategory.carb, qualityScore: 90,
      portionLabel: '½ cebolla mediana (~55g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'apio', name: 'Apio',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '2 ramas (~80g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'champinones', name: 'Champiñones',
      category: FoodCategory.carb, qualityScore: 95,
      portionLabel: '1 taza (~70g)', servingUnit: ServingUnit.cup,
      searchAliases: ['hongos', 'setas', 'mushrooms', 'champiñones'],
    ),
    Food(
      id: 'berenjena', name: 'Berenjena',
      category: FoodCategory.carb, qualityScore: 95,
      portionLabel: '1 taza en cubos (~82g)', servingUnit: ServingUnit.cup,
      searchAliases: ['aubergine', 'eggplant'],
    ),
    Food(
      id: 'kale', name: 'Kale',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '1 taza (~67g)', servingUnit: ServingUnit.cup,
      searchAliases: ['col rizada', 'berza'],
    ),
    Food(
      id: 'acelga', name: 'Acelga',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '1 taza (~36g)', servingUnit: ServingUnit.cup,
      searchAliases: ['chard'],
    ),
    Food(
      id: 'cilantro', name: 'Cilantro',
      category: FoodCategory.carb, qualityScore: 100,
      portionLabel: '¼ taza (~4g)', servingUnit: ServingUnit.handful,
      searchAliases: ['coriander'],
    ),
    Food(
      id: 'ajo', name: 'Ajo',
      category: FoodCategory.carb, qualityScore: 95,
      portionLabel: '1 diente (~3g)', servingUnit: ServingUnit.unit,
      searchAliases: ['garlic'],
    ),
    Food(
      id: 'jengibre', name: 'Jengibre',
      category: FoodCategory.carb, qualityScore: 95,
      portionLabel: '1 cucharadita (~5g)', servingUnit: ServingUnit.tablespoon,
      searchAliases: ['ginger', 'gengibre'],
    ),
    Food(
      id: 'remolacha', name: 'Remolacha',
      category: FoodCategory.carb, qualityScore: 45,
      portionLabel: '1 remolacha mediana (~100g)', servingUnit: ServingUnit.unit,
    ...
    Food(
      id: 'fresa', name: 'Fresa',
      category: FoodCategory.carb, qualityScore: 80,
      portionLabel: '1 taza (~150g)', servingUnit: ServingUnit.cup,
      searchAliases: ['frutilla'],
    ),
    Food(
      id: 'frambuesa', name: 'Frambuesa',
      category: FoodCategory.carb, qualityScore: 80,
      portionLabel: '1 taza (~123g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'arandanos', name: 'Arándanos',
      category: FoodCategory.carb, qualityScore: 70,
      portionLabel: '1 taza (~148g)', servingUnit: ServingUnit.cup,
      searchAliases: ['blueberries'],
    ),
    Food(
      id: 'mora', name: 'Mora',
      category: FoodCategory.carb, qualityScore: 70,
      portionLabel: '1 taza (~144g)', servingUnit: ServingUnit.cup,
      searchAliases: ['blackberry', 'zarzamora', 'moras'],
    ),
    Food(
      id: 'uchuva', name: 'Uchuva',
      category: FoodCategory.carb, qualityScore: 60,
      portionLabel: '1 taza (~100g)', servingUnit: ServingUnit.cup,
      searchAliases: ['uvilla', 'physalis', 'cape gooseberry'],
    ),
    Food(
      id: 'manzana', name: 'Manzana',
      category: FoodCategory.carb, qualityScore: 65,
      portionLabel: '1 manzana mediana (~182g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'pera', name: 'Pera',
      category: FoodCategory.carb, qualityScore: 50,
      portionLabel: '1 pera mediana (~178g)', servingUnit: ServingUnit.unit,
      searchAliases: ['pear'],
    ),
    Food(
      id: 'durazno', name: 'Durazno',
      category: FoodCategory.carb, qualityScore: 50,
      portionLabel: '1 durazno mediano (~150g)', servingUnit: ServingUnit.unit,
      searchAliases: ['melocoton', 'melocotón', 'peach'],
    ),
    Food(
      id: 'kiwi', name: 'Kiwi',
      category: FoodCategory.carb, qualityScore: 60,
      portionLabel: '1 kiwi mediano (~77g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'guayaba', name: 'Guayaba',
      category: FoodCategory.carb, qualityScore: 55,
      portionLabel: '1 guayaba mediana (~90g)', servingUnit: ServingUnit.unit,
      searchAliases: ['guava'],
    ),
    Food(
      id: 'limon', name: 'Limón',
      category: FoodCategory.carb, qualityScore: 90,
      portionLabel: '1 limón mediano (~58g)', servingUnit: ServingUnit.unit,
      searchAliases: ['lima', 'lemon'],
    ),
    Food(
      id: 'uvas', name: 'Uvas',
      category: FoodCategory.carb, qualityScore: 35,
      portionLabel: '1 taza (~150g)', servingUnit: ServingUnit.cup,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 45,
      portionLabel: '1 mandarina mediana (~88g)', servingUnit: ServingUnit.unit,
      searchAliases: ['tangerina'],
    ),
    Food(
      id: 'naranja', name: 'Naranja',
      category: FoodCategory.carb, qualityScore: 40,
      portionLabel: '1 naranja mediana (~131g)', servingUnit: ServingUnit.unit,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 25,
      portionLabel: '1 banano mediano (~118g)', servingUnit: ServingUnit.unit,
      searchAliases: ['banana', 'guineo'],
    ),
    Food(
      id: 'mango', name: 'Mango',
      category: FoodCategory.carb, qualityScore: 20,
      portionLabel: '1 taza en cubos (~165g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'papaya', name: 'Papaya',
      category: FoodCategory.carb, qualityScore: 30,
      portionLabel: '1 taza en cubos (~140g)', servingUnit: ServingUnit.cup,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 40,
      portionLabel: '1 maracuyá (~18g pulpa)', servingUnit: ServingUnit.unit,
      searchAliases: ['passion fruit', 'parchita'],
    ),
    Food(
      id: 'melon', name: 'Melón',
      category: FoodCategory.carb, qualityScore: 25,
      portionLabel: '1 taza en cubos (~160g)', servingUnit: ServingUnit.cup,
      searchAliases: ['cantalupo', 'cantaloupe'],
    ),
    Food(
      id: 'sandia', name: 'Sandía',
      category: FoodCategory.carb, qualityScore: 20,
      portionLabel: '1 taza en cubos (~154g)', servingUnit: ServingUnit.cup,
      searchAliases: ['patilla', 'watermelon'],
    ),
    Food(
      id: 'platano', name: 'Plátano',
      category: FoodCategory.carb, qualityScore: 20,
      portionLabel: '½ plátano (~75g)', servingUnit: ServingUnit.unit,
    ),
    ...
    Food(
      id: 'avena', name: 'Avena',
      category: FoodCategory.carb, qualityScore: 35,
      portionLabel: '½ taza cruda (~40g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'arroz_integral', name: 'Arroz integral',
      category: FoodCategory.carb, qualityScore: 30,
      portionLabel: '½ taza cocido', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'pan_integral', name: 'Pan integral',
      category: FoodCategory.carb, qualityScore: 30,
      nova: NovaGroup.processed,
      portionLabel: '1 rebanada (~30g)', servingUnit: ServingUnit.slice,
    ),

    // Almidones densos
    Food(
      id: 'papa', name: 'Papa',
      category: FoodCategory.carb, qualityScore: 10,
      portionLabel: '1 papa mediana (~150g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'papa_criolla', name: 'Papa criolla',
      category: FoodCategory.carb, qualityScore: 12,
      portionLabel: '3 papas criollas (~100g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'yuca', name: 'Yuca',
      category: FoodCategory.carb, qualityScore: 10,
      portionLabel: '½ taza cocida (~75g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'batata_camote', name: 'Batata / camote',
      category: FoodCategory.carb, qualityScore: 18,
      portionLabel: '½ batata mediana (~100g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'tapioca', name: 'Tapioca',
      category: FoodCategory.carb, qualityScore: 10,
      portionLabel: '¼ taza seca (~40g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'maiz', name: 'Maíz',
      category: FoodCategory.carb, qualityScore: 15,
      portionLabel: '½ taza / ½ mazorca', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'mazorca', name: 'Mazorca',
      category: FoodCategory.carb, qualityScore: 15,
      portionLabel: '1 mazorca (~200g)', servingUnit: ServingUnit.unit,
    ...
    Food(
      id: 'pan', name: 'Pan',
      category: FoodCategory.carb, qualityScore: 8,
      nova: NovaGroup.processed,
      portionLabel: '1 tajada (~35g)', servingUnit: ServingUnit.slice,
    ),
    Food(
      id: 'pasta', name: 'Pasta',
      category: FoodCategory.carb, qualityScore: 10,
      portionLabel: '½ taza cocida (~80g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'arepa', name: 'Arepa',
      category: FoodCategory.carb, qualityScore: 15,
      portionLabel: '1 arepa mediana (~80g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'tortilla', name: 'Tortilla',
      category: FoodCategory.carb, qualityScore: 12,
      portionLabel: '1 tortilla mediana (~45g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'harina', name: 'Harina',
      category: FoodCategory.carb, qualityScore: 8,
      portionLabel: '¼ taza (~30g)', servingUnit: ServingUnit.cup,
    ),
    Food(
      id: 'galletas', name: 'Galletas',
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '4-5 galletas (~30g)', servingUnit: ServingUnit.handful,
    ),
    Food(
      id: 'cereal', name: 'Cereal',
      category: FoodCategory.carb, qualityScore: 10,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 taza (~30g)', servingUnit: ServingUnit.cup,
    ...
    Food(
      id: 'pandebono', name: 'Pandebono',
      category: FoodCategory.carb, qualityScore: 8,
      nova: NovaGroup.processed,
      portionLabel: '1 pandebono (~50g)', servingUnit: ServingUnit.unit,
    ),
    Food(
      id: 'bunuelo', name: 'Buñuelo',
      category: FoodCategory.carb, qualityScore: 8,
      nova: NovaGroup.processed,
      portionLabel: '1 buñuelo mediano (~50g)', servingUnit: ServingUnit.unit,
      searchAliases: ['buñuelo'],
    ),
    Food(
      id: 'patacon', name: 'Patacón',
      category: FoodCategory.carb, qualityScore: 10,
      nova: NovaGroup.processed,
      portionLabel: '2 patacones (~80g)', servingUnit: ServingUnit.unit,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 10,
      nova: NovaGroup.processed,
      portionLabel: '2 tostadas (~30g)', servingUnit: ServingUnit.slice,
      searchAliases: ['toast'],
    ),
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 0,
      nova: NovaGroup.culinaryIngredient,
      portionLabel: '1 cucharada (~12g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 0,
      nova: NovaGroup.culinaryIngredient,
      portionLabel: '1 cucharada rallada (~15g)', servingUnit: ServingUnit.tablespoon,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.culinaryIngredient,
      portionLabel: '1 cucharada (~21g)', servingUnit: ServingUnit.tablespoon,
    ),
    Food(
      id: 'chocolate', name: 'Chocolate',
      category: FoodCategory.carb, qualityScore: 10,
      nova: NovaGroup.processed,
      portionLabel: '1 cuadro (~28g)', servingUnit: ServingUnit.handful,
    ),
    Food(
      id: 'bocadillo', name: 'Bocadillo',
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.processed,
      portionLabel: '1 cuadro (~30g)', servingUnit: ServingUnit.unit,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 0,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '2 cucharadas (~40g)', servingUnit: ServingUnit.tablespoon,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 porción (1/8 pizza)', servingUnit: ServingUnit.slice,
    ),
    Food(
      id: 'hamburguesa', name: 'Hamburguesa',
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 hamburguesa', servingUnit: ServingUnit.unit,
      searchAliases: ['burger'],
    ),
    Food(
      id: 'salchipapa', name: 'Salchipapa',
      category: FoodCategory.carb, qualityScore: 3,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 porción', servingUnit: ServingUnit.unit,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 10,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 sándwich', servingUnit: ServingUnit.unit,
      searchAliases: ['sandwch', 'emparedado'],
    ),
    Food(
      id: 'empanada', name: 'Empanada',
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 empanada', servingUnit: ServingUnit.unit,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 paquete pequeño (~30g)', servingUnit: ServingUnit.handful,
      searchAliases: ['papas fritas', 'crisps', 'papas de paquete'],
    ),
    Food(
      id: 'galletas_dulces', name: 'Galletas dulces',
      category: FoodCategory.carb, qualityScore: 3,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '3-4 galletas (~30g)', servingUnit: ServingUnit.handful,
      searchAliases: ['cookies'],
    ),
    Food(
      id: 'galletas_saladas', name: 'Galletas saladas',
      category: FoodCategory.carb, qualityScore: 8,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '5-6 galletas (~30g)', servingUnit: ServingUnit.handful,
    ...
    Food(
      id: 'cafe_leche', name: 'Café con leche',
      category: FoodCategory.carb, qualityScore: 35,
      portionLabel: '1 taza (240ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['cafe con leche', 'latte'],
    ),
    Food(
      id: 'capuchino', name: 'Capuchino',
      category: FoodCategory.carb, qualityScore: 35,
      portionLabel: '1 taza (240ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['cappuccino'],
    ),
    Food(
      id: 'chocolate_caliente', name: 'Chocolate caliente',
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 taza (240ml)', servingUnit: ServingUnit.cup,
    ...
    Food(
      id: 'jugo_leche', name: 'Jugo en leche',
      category: FoodCategory.carb, qualityScore: 10,
      portionLabel: '1 vaso (240ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['batido', 'licuado con leche'],
    ),
    Food(
      id: 'jugo_agua', name: 'Jugo en agua',
      category: FoodCategory.carb, qualityScore: 15,
      portionLabel: '1 vaso (240ml)', servingUnit: ServingUnit.cup,
      searchAliases: ['jugo natural', 'licuado con agua'],
    ),
    Food(
      id: 'agua_de_panela', name: 'Agua de panela',
      category: FoodCategory.carb, qualityScore: 5,
      nova: NovaGroup.culinaryIngredient,
      portionLabel: '1 vaso (240ml)', servingUnit: ServingUnit.cup,
    ...
    Food(
      ...
      category: FoodCategory.carb, qualityScore: 0,
      nova: NovaGroup.ultraProcessed,
      portionLabel: '1 lata (355ml)', servingUnit: ServingUnit.cup,
