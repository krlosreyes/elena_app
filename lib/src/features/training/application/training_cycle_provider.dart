...
part 'training_cycle_provider.g.dart';

@Riverpod(keepAlive: true)
class TrainingCycleProvider extends _$TrainingCycleProvider {
  @override
  TrainingCycle build() {
  ...
  void incrementSession() {
    final current = state;
    if (current.isDeloadActive) return; // Don't count deload sessions towards the next block yet? Or do we?
