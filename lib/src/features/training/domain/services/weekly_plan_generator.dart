...
class WeeklyPlanGenerator {
  static List<DailyWorkout> generate(
    WorkoutGoal goal, {
    required int age,
    ...
    for (int day = 1; day <= 7; day++) {
      if (sortedWorkoutDays.contains(day)) {
        ...
        if (strengthSessionCount % 3 == 0) {
          routineType = 'A';
        } else if (strengthSessionCount % 3 == 1) {
          routineType = 'B';
        } else {
          routineType = 'C';
        }
        ...
        plan.add(
            _strengthDay(day, description, rir, hasDumbbells, routineType));
      } else {
  ...
  static DailyWorkout _strengthDay(int day, String desc, String details,
      bool hasDumbbells, String routineType) {
    return DailyWorkout(
      dayIndex: day,
  ...
  static DailyWorkout _cardioDay(
      int day, int mins, String desc, String details) {
    return DailyWorkout(
      dayIndex: day,
  ...
  static List<RoutineExercise> _getExercisesFor(
      String routine, bool hasDumbbells) {
    if (hasDumbbells) {
      switch (routine) {
        case 'A': // Lunes: Empuje/Pierna Dominante
          return [
            ...
            const RoutineExercise(
                ...
                sets: 3,
                targetReps: '10/pierna',
                rir: 2,
                restSeconds: 60),
            const RoutineExercise(
                id: 'shoulder_press_seated',
        ...
        case 'B': // Miércoles: Tracción/Cadera Dominante
          return [
            ...
            const RoutineExercise(
                id: 'step_ups_db',
                name: 'Step-ups (Silla/Banco)',
                sets: 3,
                targetReps: '10/pierna',
                rir: 2,
                restSeconds: 60),
            const RoutineExercise(
                id: 'inclined_press_db',
                name: 'Press Inclinado (o Puente)',
                sets: 3,
                targetReps: '10-12',
                rir: 2,
                restSeconds: 90),
        ...
        case 'C': // Viernes: Híbrido/Accesorios
          return [
            ...
            const RoutineExercise(
                id: 'dips_chair',
                name: 'Fondos de Tríceps (Silla)',
                sets: 3,
                targetReps: 'Al fallo',
                rir: 1,
                restSeconds: 60),
            const RoutineExercise(
                id: 'lateral_lunges_db',
      ...
      switch (routine) {
        case 'A':
          return [
            const RoutineExercise(
                id: 'air_squat',
                name: 'Sentadilla Aire (Bodyweight)',
                sets: 4,
                targetReps: '20-25',
                rir: 2,
                restSeconds: 60),
            ...
            const RoutineExercise(
                ...
                sets: 3,
                targetReps: '15/pierna',
                rir: 2,
                restSeconds: 60),
            const RoutineExercise(
                id: 'pike_pushups',
                name: 'Pike Pushups (Hombro)',
                sets: 3,
                targetReps: '8-12',
                rir: 2,
                restSeconds: 90),
        ...
        case 'B':
          return [
            ...
            const RoutineExercise(
                id: 'backpack_curl',
                name: 'Curl con Mochila/Resistencia',
                sets: 3,
                targetReps: '15-20',
                rir: 1,
                restSeconds: 60),
        ...
        case 'C':
          return [
            ...
            const RoutineExercise(
                ...
                restSeconds: 60),
            const RoutineExercise(
                id: 'lateral_lunges_bw',
                name: 'Zancada Lateral',
                sets: 3,
                targetReps: '12/pierna',
                rir: 2,
                restSeconds: 60),
            const RoutineExercise(
                id: 'lateral_raises_bottle',
                name: 'Elevaciones Laterales (Botellas)',
                sets: 3,
                targetReps: '20-25',
                rir: 1,
                restSeconds: 45),
