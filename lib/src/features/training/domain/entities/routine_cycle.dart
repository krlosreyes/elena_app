...
class RoutineCycle with _$RoutineCycle {
  const factory RoutineCycle({
    ...
    required String
        goalDescriptive, // e.g. "Recomposición Corporal - Sin Mancuernas"
  }) = _RoutineCycle;

  factory RoutineCycle.fromJson(Map<String, dynamic> json) =>
...
class RoutineDay with _$RoutineDay {
  const factory RoutineDay({
    ...
    @Default('Descanso')
    String type, // "Full Body", "Cardio Zona 2", "Descanso Activo"
