...
void main() {
  ...
  group('targetForProtocol — tabla canónica', () {
  ...
  group('knownProtocols', () {
    test('expone los 4 valores canónicos', () {
      expect(service.knownProtocols, hasLength(4));
      expect(service.knownProtocols,
          containsAll(['Ninguno', '16:8', '18:6', '20:4']));
    });
    ...
    test('progresión coherente: menos ventana → menos comidas', () {
      final ninguno = service.targetForProtocol('Ninguno').meals;
      ...
      expect(ninguno, greaterThanOrEqualTo(p16),
          reason: 'Ninguno (~14h ventana) ≥ 16:8 (8h)');
